...
**Correction (2026-08-30) — the middle colour is AMBER.** Founder Ruling 12 on [[GTC-192]] names the system's-on-it colour **amber** everywhere. This document previously used **orange** (§3, §4) and **yellow** (§8.2, §8.5, §10.8) for the same single state — an internal inconsistency, not two states. All five sites are corrected in place below, each carrying an inline marker so the edit is visible rather than silent. ⚠ **The Hinge spec is NOT changed by this pass** — its §7 explicitly constructs yellow as *"the Moment 4 walk's orange; same axis, calmer opening shade"*, a deliberate shade distinction that collapsing to one word would destroy. That is recorded as an open question on GTC-192, not decided here.
...
- **Amber** — the system is on it (e.g. actively nudging a silence). *[amber — was "Orange"; renamed by founder ruling, GTC-192 Ruling 12, 2026-08-30]*
...
- **The door swings both ways at red:** tapping it, Kate can (a) flick it back to amber *[amber — was "orange"; renamed by founder ruling, GTC-192 Ruling 12, 2026-08-30]* for more system tries, with a retry count she specifies, or (b) keep it red and handle it herself.
...
**8.2 Critical items in the grid — RESOLVED: badge.** Critical items carry a badge (set at menu time, Moment 2) visible in the grid. No float-to-top, no message-only. Four seconds can tell the lamb from the ice before anything goes wrong; a badged amber *[amber — was "yellow"; renamed by founder ruling, GTC-192 Ruling 12, 2026-08-30]* box still means rest. The assistant's one plain message remains the escalation when a critical goes red.
...
> **⚠ THE LAST SENTENCE OF 8.7 BELOW IS OVERTURNED — founder ruling, 2026-09-13.** *"No-channel adults route via the Moment 1 recipient toggle"* no longer holds. An adult with neither email nor phone is not routed through anyone: they become a line on the host's list, named with their item, for her to handle out of band. See [[GTC-189]], *Founder ruling — the recipient and channel model (Nigel, 2026-09-13)*. This banner names that sentence only. The prose below is left as written; the ruling governs where they disagree.

> **⚠ "THEREFORE A CHILD'S ROW CANNOT GO RED" IN 8.7 BELOW IS OVERTURNED — founder ruling, 2026-09-14.** A child's row goes red when the message carrying their ask bounced: the ask reached nobody, and the board says so. See [[GTC-189]], *Founder rulings — third pass (Nigel, 2026-09-14)*, ruling S. The ruling names the bounce; a declined or expired carried row is not ruled there. The same sentence's second half, *"child-owned rows never run the escalation machinery at all"*, is reached by ruling R of the same pass: a carried ask is chased like any other — and by **ruling Z of the fourth pass, 2026-09-15**, which adds the decide-by follow-up: the carrier receives it for a carried child's maybe, because *"we talk to Ollie through Sarah, and that does not stop being true at the decide-by date"*. Between them the two rulings reach both halves of the escalation machinery, the chase and the follow-up. Nothing is sent to a child by either. This banner names that sentence only. The prose below is left as written; the ruling governs where they disagree.
...
**10.8 The grid is person-primary.** People are the boxes; items live inside the person. Jake's box is amber *[amber — was "yellow"; renamed by founder ruling, GTC-192 Ruling 12, 2026-08-30]* with the pavlova in it; a person holding items in different states shows the **worst colour**, with all items visible on tap. The wondering was always about people — who's responded, who's silent — and "who's coming and what they're bringing" puts the who first. Items-as-primary is the spreadsheet's view: the thing the product replaced. "Is the lamb covered?" is answered by the badge and the assistant's message, not by inverting the grid. A matrix fails the four-second test.
