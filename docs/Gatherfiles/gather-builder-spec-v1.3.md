# Gather: Builder's Specification — v1.3 (Redlined)

## For Claude Code Implementation

**Version:** 1.3 (Redlined from v1.2)  
**Date:** December 2025  
...
- [x] Schema has required fields + relations (AccessToken.teamId for COORDINATOR, Team.tokens relation)
- [x] Seed data references only real schema fields (removed event.hostName, uses hostId reference)
- [x] Coordinator tokens cannot exist without teamId and matching membership (invariant added)
...
model Item {
  ...
  **[ADD: dropOffAt            DateTime?   // When to drop off (computed datetime)]**
  dropOffLocation      String?     // e.g., "Kate's Kitchen", "Marquee"
  **[ADD: dropOffNote          String?     // Human-readable time note, e.g., "12 noon", "after mains"]**
...
**[ADD: 4. Token-team consistency (COORDINATOR scope):** When creating an AccessToken with `scope = COORDINATOR`:
...
**[ADD: 5. Item.status as cached mirror:** `Item.status` is a cached representation of whether an Assignment exists:
...
**[ADD: 6. Delete cascade behavior:** Deleting an Item cascades to delete its Assignment (via Prisma `onDelete: Cascade` on Assignment.itemId). Team status recomputes on next read. Delete rules:
   - FROZEN: delete blocked (no override)
   - CONFIRMING: delete allowed only if `item.critical === false`
   - DRAFT: delete always allowed**]**

**[ADD: ### Role vs Coordinator Authority Clarification
...
- **[ADD: For COORDINATOR tokens: validate `teamId` matches person's `PersonEvent.teamId` before creation]**
...
| DELETE | `/api/c/[token]/items/[itemId]` | Delete item (blocked if frozen~~, never if critical~~) **[ADD: ; in CONFIRMING state, blocked if critical]** |
| POST | `/api/c/[token]/items/[itemId]/assign` | Assign person (must be in same team) |
| DELETE | `/api/c/[token]/items/[itemId]/assign` | Remove assignment **[ADD: (sets Item.status = UNASSIGNED)]** |
...
const MUTATION_RULES = {
  ...
  FROZEN: {
    ...
    deleteItem: false, // Never allowed while frozen **[ADD: (no override)]**
...
- Assigned items with: name, quantity, constraints, day, ~~time~~ **[ADD: dropOffAt formatted as date/time]**, location
- **[ADD: dropOffNote (if present) shown as human-readable hint]**
...
const event = {
  ...
  status: "CONFIRMING",
  ~~hostName: "Jacqui",~~
  **[ADD: // hostId will reference Jacqui's Person.id after Person creation]**
};
```
...
const dropOff = {
  ...
  **[ADD: eve: { at: new Date("2025-12-24T17:30:00.000Z"), location: "Kate's Kitchen", note: "5:30pm" },]**
  **[ADD: day: { at: new Date("2025-12-25T12:00:00.000Z"), location: "Marquee", note: "12 noon" },]**
  **[ADD: box: { at: new Date("2025-12-26T12:00:00.000Z"), location: "Marquee", note: "12 noon" },]**
};
```
...
**[ADD: // coordinatorName is resolved to coordinatorId after Person creation]**
```
...
**[ADD: // teamName is resolved to teamId after Team creation]**
**[ADD: // role is used for PersonEvent.role]**
```
...
**[ADD: Note: All `dropOffTime` fields have been replaced with `dropOffAt` (DateTime) and `dropOffNote` (String).]**
...
const items = [
  ...
  { 
    ...
    ~~dropOffTime: "5:30pm",~~
    **[ADD: dropOffAt: new Date("2025-12-24T17:30:00.000Z"),]**
    **[ADD: dropOffNote: "5:30pm",]**
  ...
  { 
    ...
    **[ADD: dropOffAt: new Date("2025-12-25T12:00:00.000Z"),]**
    **[ADD: dropOffNote: "12 noon",]**
  ...
  { 
    ...
    name: "Potato gratin", 
    quantity: "3", 
    assigneeName: null, // Originally Kate, Robyn, Dougal (all Mains)
    glutenFree: false, 
    dayName: "Christmas Eve",
    **[ADD: dropOffAt: new Date("2025-12-24T17:30:00.000Z"),]**
    **[ADD: dropOffNote: "5:30pm",]**
  ...
  { 
    ...
    name: "Sweet platters", 
    quantity: "Platter", 
    assigneeName: null, // Originally Joanna (Entrées)
    dayName: "Christmas Eve",
    **[ADD: dropOffAt: new Date("2025-12-24T17:30:00.000Z"),]**
    **[ADD: dropOffNote: "5:30pm",]**
    dropOffLocation: "Kate's Kitchen",
  ...
  { 
    ...
    quantity: "Tray", 
    assigneeName: null, // Originally Kate (Mains)
    glutenFree: true, 
    dayName: "Christmas Eve",
    **[ADD: dropOffAt: new Date("2025-12-24T17:30:00.000Z"),]**
    **[ADD: dropOffNote: "5:30pm",]**
  ...
  { 
    ...
    quantity: "1", 
    assigneeName: null, // Originally Jacqui (Veg)
    glutenFree: true, 
    dayName: "Christmas Day",
    **[ADD: dropOffAt: new Date("2025-12-25T12:00:00.000Z"),]**
    **[ADD: dropOffNote: "12 noon",]**
  ...
  { 
    ...
    name: "Pavlova", 
    quantity: "1", 
    assigneeName: null, // Originally Ian (Drinks)
    dairyFree: true, 
    dayName: "Christmas Day",
    **[ADD: dropOffAt: new Date("2025-12-25T12:00:00.000Z"),]**
    **[ADD: dropOffNote: "12 noon",]**
  ...
  { 
    ...
    name: "Berries", 
    quantity: "Plenty", 
    assigneeName: null, // Originally Gus (Later Food)
    glutenFree: true, 
    dairyFree: true, 
    dayName: "Christmas Day",
    **[ADD: dropOffAt: new Date("2025-12-25T12:00:00.000Z"),]**
  ...
  { 
    ...
    dairyFree: true, 
    dayName: "Boxing Day",
    **[ADD: dropOffAt: new Date("2025-12-26T12:00:00.000Z"),]**
    **[ADD: dropOffNote: "12 noon",]**
    dropOffLocation: "Marquee",
    critical: false,
  },
  ...
  { 
    ...
    quantity: "1", 
    assigneeName: null, // Originally Robyn (Mains)
    dayName: "Boxing Day",
    **[ADD: dropOffAt: new Date("2025-12-26T12:00:00.000Z"),]**
    **[ADD: dropOffNote: "12 noon",]**
    dropOffLocation: "Marquee",
  ...
  { 
    ...
    glutenFree: true, 
    dairyFree: true, 
    dayName: null, // All days
    **[ADD: dropOffAt: null,]**
    **[ADD: dropOffNote: "Bring on arrival",]**
  ...
  { 
    ...
    quantity: "All tables", 
    assigneeName: null, // Originally Anika, Jacqui (other teams)
    dayName: "Christmas Day",
    **[ADD: dropOffAt: new Date("2025-12-25T10:00:00.000Z"),]**
    **[ADD: dropOffNote: "10:00am",]**
    dropOffLocation: "Marquee",
    critical: true,
...
6. Create `prisma/seed.ts`:
   - **[ADD: Follow seed order from Section 8: People → Event → Days → Teams → PersonEvent → Items → Assignments → AccessTokens]**
   - **[ADD: Validate COORDINATOR token teamId matches PersonEvent.teamId]**
   - **[ADD: Validate Assignment person is in same team as item]**
...
8. Create `lib/auth.ts`:
   ...
   - **[ADD: For COORDINATOR tokens, verify teamId matches PersonEvent.teamId]**
...
16. Create `POST /api/c/[token]/items/[itemId]/assign`
    - **[ADD: Validate assignee's PersonEvent.teamId === item.teamId]**
    - **[ADD: Set Item.status = ASSIGNED after creating Assignment]**
...
20. Create `lib/workflow.ts`:
    ...
    - **[ADD: `repairItemStatus(item)` → ensures status matches Assignment existence]**
...
26. **[ADD: Test COORDINATOR token validation (teamId must match)]**
...
- [ ] Shows ~~drop-off time~~ **[ADD: dropOffAt formatted as date/time]** and location
- [ ] **[ADD: Shows dropOffNote if present]**
...
- [ ] **[ADD: Token validation verifies teamId matches PersonEvent.teamId]**
...
- [ ] **[ADD: Assignment creation sets Item.status = ASSIGNED]**
...
- [ ] **[ADD: Delete in CONFIRMING blocked if item.critical === true]**
...
- [ ] **[ADD: COORDINATOR tokens have non-null teamId matching PersonEvent.teamId]**
- [ ] **[ADD: Item.status is consistent with Assignment existence (repaired on read if mismatched)]**
- [ ] 55 items loaded
...
│   │   ├── auth.ts                 # Token resolution **[ADD: + COORDINATOR teamId validation]**
│   │   └── workflow.ts             # Mutation guards, status computation **[ADD: + repairItemStatus]**
│   └── components/
│       ├── ItemCard.tsx
│       ├── TeamCard.tsx
│       ├── StatusBadge.tsx
...
```
Read the attached Gather Builder's Specification v1.3 completely.
...
- Item.status is a cached mirror of Assignment existence (repair on read if mismatch)
...
Attached: gather-builder-spec-v1.3.md
```
