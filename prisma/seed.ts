...
async function main() {
  ...
  const teamsData = [
    ...
    { name: 'Mains – Proteins', scope: 'Centre protein dishes for 36-40', coordinatorName: 'Kate' },
    {
      ...
      scope: 'Salads + hot veg, volume + balance',
      coordinatorName: 'Jacqui & Ian',
    },
  ...
  const dropOff = {
    eve: {
      at: makeNzdtChristmas2025Date('2025-12-24', '17:30'),
      location: "Kate's Kitchen",
      note: '5:30pm',
    },
    day: {
  ...
  const itemsData = [
    ...
    {
      teamName: 'Entrées & Nibbles',
      name: 'Potato chips, nuts, nibbles',
      quantity: 'Plenty',
      assigneeName: 'Pete',
      dayName: 'Christmas Eve',
      ...dropOff.eve,
