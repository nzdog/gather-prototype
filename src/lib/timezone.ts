 ...
 * ⚠️  For December 2026, this is correct. For other dates, verify offset.
 *
 ...
 */
export function makeNzdtChristmasDate(dateStr: string, timeStr: string): Date {
  const [year, month, day] = dateStr.split('-').map(Number);
  const [hour, minute] = timeStr.split(':').map(Number);

  // NZDT offset: UTC+13 (valid for Christmas 2026)
...
// makeNzdtChristmasDate("2026-12-24", "17:30") → 2026-12-24T04:30:00.000Z (5:30pm NZ)
// makeNzdtChristmasDate("2026-12-25", "12:00") → 2026-12-24T23:00:00.000Z (12 noon NZ)
// makeNzdtChristmasDate("2026-12-25", "10:00") → 2026-12-24T21:00:00.000Z (10am NZ)
