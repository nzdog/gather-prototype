    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Upgrade to Gather Annual</h1>
          <p className="text-xl text-gray-600">Unlock unlimited events and premium features</p>
        </div>
